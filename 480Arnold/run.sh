...
python arnold.py --exp_name test --main_dump_path ./dumped \
--scenario defend_the_center --frame_skip 2 --action_combinations "turn_lr+attack" \
--reload ../../../pretrained/defend_the_center.pth --evaluate 1 --visualize 1 --gpu_id -1
fi
...
--reload ../../../pretrained/health_gathering.pth --evaluate 1 --visualize 1 --gpu_id -1
fi
...
echo "Map ID          : 1"
echo "Human player    : ${H}"
python3 arnold.py --exp_name test --main_dump_path ./dumped \
...
--reload ../../../pretrained/vizdoom_2017_track1.pth --evaluate 1 --visualize 1 --gpu_id -1
fi
...
--num_players ${P} --n_bots ${B} --human_player ${H} \
--reload ../../../pretrained/vizdoom_2017_track2.pth --evaluate 1 --visualize 1 --gpu_id -1
 fi

if [ "$1" == "sf" ]; then
echo "Number of agents: 1"
echo "Number of bots  : 7"
echo "Map ID          : 1"
echo "Human player    : ${H}"
python3 arnold.py --exp_name test --main_dump_path ./dumped \
--frame_skip 4 --action_combinations "move_fb+move_lr;turn_lr;attack" \
...
--labels_mapping "" --game_features "target,enemy" --bucket_size "[10, 1]" --dropout 0.5 \
--speed "on" --crouch "off" --map_ids_test 1 --manual_control 1 \
--scenario "self_play" --execute "deathmatch" --wad "dwango5" --render_hud 1 \
--num_players ${P} --n_bots 7 --human_player ${H} \
--reload ../../../pretrained/vizdoom_2017_track2.pth --evaluate 1 --visualize 0 --gpu_id -1
 fi
...
--labels_mapping "" --game_features "target,enemy" --bucket_size "[10, 1]" --dropout 0.5 \
--speed "on" --crouch "off" --map_ids_test 1 --manual_control 1 \
--scenario "deathmatch" --wad "dwango5" --render_hud 1 \
--players_per_game 3 \
--reload ../../../pretrained/vizdoom_2017_track2.pth --evaluate 1 --visualize 1 --gpu_id -1
 fi
