...
class Game(object):
    ...
    def __init__(
        ...
        visible=False,
        n_bots=0, use_scripted_marines=True,
        doom_skill=2
    ):
        """
        Create a new game.
    ...
    def update_statistics_and_reward(self, action):
        ...
        # death
        if self.game.is_player_dead() and self.properties['health'] != -999900:
    ...
    def start(self, map_id, episode_time=None, manual_control=False, log_events=False):
        ...
        # assert self.game.load_config("./resources/scenarios/cig.cfg") is True
        # map
        assert map_id > 0
        self.map_id = map_id
        ...
        args.append('+sv_respawnprotect 2')
    ...
    def make_action(self, action, frame_skip=1, sleep=None):
        ...
        # print(self.game.get_game_variable(GameVariable.USER2))
        # print('pf', self.game.get_game_variable(GameVariable.PLAYER1_FRAGCOUNT))
        # print('f', self.game.get_game_variable(GameVariable.FRAGCOUNT))
        # print('k', self.game.get_game_variable(GameVariable.KILLCOUNT))
        self.update_game_variables()
