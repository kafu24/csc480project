...
class ActionBuilder(object):
    ...
    def __init__(self, params):
        ...
        if params.use_continuous:
            ...
            self.doom_actions = []
            for i, sub_actions in enumerate(self.available_actions):
...
def get_available_buttons(params):
    ...
    assert not params.use_continuous
