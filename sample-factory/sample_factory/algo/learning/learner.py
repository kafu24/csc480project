...
class Learner(Configurable):
    ...
    def _load_state(self, checkpoint_dict, load_progress=True):
        ...
        self.actor_critic.load_state_dict(checkpoint_dict["model"], False)
    ...
    def load_from_checkpoint(self, policy_id: PolicyID, load_progress: bool = True) -> None:
        ...
        if checkpoint_dict is None:
            ...
            # checkpoint_dict['model']['core.core.weight_ih_l0'] = torch.cat([checkpoint_dict['model']['core.core.weight_ih_l0'], torch.randn(1536, 128).cuda()], dim=1)
